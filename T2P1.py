...
modelo_mlp.fit(X_trainS, Y_train)
Y_pred_mlp = modelo_mlp.predict(X_testS)
...
for sigmaR in sigmas:
    ...
    Y_pred_mlp_train = modelo_mlp.predict(X_train_scaled)
    Y_pred_mlp_test = modelo_mlp.predict(X_test_scaled)
